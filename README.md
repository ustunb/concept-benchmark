...
Generate the paper dataset and train a CBM (see [Quick Start](#robot-classification) for the full training code):
...
Generate the paper dataset (see [Quick Start](#sudoku-validation) for the full training code):
