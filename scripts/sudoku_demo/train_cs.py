...
from scripts.sudoku_demo.sudoku_models import ConceptSudokuCNN
...
cd = ConceptDetector(model=ConceptSudokuCNN())  # TODO: Replace with actual concept detector class
