...
train_accuracy = (model.predict(clean_data.training.C) == clean_data.training.y).mean()
val_accuracy = (model.predict(clean_data.validation.C) == clean_data.validation.y).mean()
test_accuracy = (model.predict(clean_data.test.C) == clean_data.test.y).mean()
