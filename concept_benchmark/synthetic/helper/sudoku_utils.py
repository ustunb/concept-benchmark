...
def shuffle_rows(board: np.ndarray, n: int | None = None, rng: np.random.Generator | None = None) -> np.ndarray:
...
def shuffle_columns(board: np.ndarray, n: int | None = None, rng: np.random.Generator | None = None) -> np.ndarray:
    N, n0 = _assert_board_size(board)
    n = n0 if n is None else n
...
def shuffle_row_bands(board: np.ndarray, n: int | None = None, rng: np.random.Generator | None = None) -> np.ndarray:
...
def shuffle_col_stacks(board: np.ndarray, n: int | None = None, rng: np.random.Generator | None = None) -> np.ndarray:
    _, n0 = _assert_board_size(board)
    n = n0 if n is None else n
    stacks = list(range(n))
    if rng is not None:
...
def relabel_digits(board: np.ndarray, N: int | None = None, rng: np.random.Generator | None = None) -> np.ndarray:
...
def generate_valid_board(n: int = 3, rng: np.random.Generator | None = None) -> np.ndarray:
